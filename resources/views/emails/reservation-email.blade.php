<div>
    ...
    <div class="container">
        ...
        <p>Su reserva del espacio '{{ $reservation->place->code }}' en el edificio
            {{ $reservation->place->building->building }} ubicado en el campus
            {{ $reservation->place->building->campus->campus }} en la
            ciudad de {{ $reservation->place->building->campus->city }} se ha realizado correctamente.</p>
