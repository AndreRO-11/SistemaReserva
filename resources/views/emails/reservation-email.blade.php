<div>
  ...
  <div class="container">
    ...
    <p>Su reserva del espacio '{{ $reservation->place->code }}' en el edificio
      {{ $reservation->place->building->building }} en el campus {{ $reservation->place->building->campus }} en la
      ciudad de {{ $reservation->place->building->city }} se ha realizado correctamente.</p>
